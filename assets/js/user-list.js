...
function ajaxUsers(page) {
    ...
    $.ajax({
        url: "http://localhost:8080/admin/user/page/" + page,
        type: "GET",
        async: true,
        data: "json",
...
function ajaxPage(page) {
    console.log("查询总页数");
    $.ajax({
        url: "http://localhost:8080/admin/page/user/",
        type: "GET",
        async: true,
        data: "json",
        success: function (result) {
    ...
    $.each(userlist, function (index, item) {
        ...
        $("#users").append(
            $('<tr>').append(
                ...
                .append(item.gender),
                $('<td>')
                .append(item.workplace),
                $('<td>')
                .append(item.last_login_time),
                $('<td>')
                .append(
                    $('<div>')
...
function del(id) {
    $.ajax({
        url: "http://localhost:8080/admin/user/id/" + id,
        type: 'DELETE',
        async: true,
        data: "json",
        success: function (result) {
