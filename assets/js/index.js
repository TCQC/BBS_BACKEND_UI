...
function ajaxStatus() {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            document.getElementById('weekly_user').textContent = result.data.weeklyUser;
...
function updateChart() {;
    $.ajax({
        url: "http://localhost:8080/admin/status/week",
        type: "GET",
        async: true,
        data: "json",
        success: function (result) {
            ...
            option = {
                ...
                series: [{
                    ...
                    data: [data.Sun, data.Sat, data.Fri, data.Thur, data.Wen, data.Tues, data.Mon],
                    itemStyle: {
                        normal: {
                            color: '#1cabdb',
                            borderColor: '#1cabdb',
